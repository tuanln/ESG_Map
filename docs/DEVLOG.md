...
- **9 API routes**: air-quality, earthquakes, disasters, fires, conflicts, news, ai-summary, countries, solutions
- **5 layers bản đồ**: AQI (■), Động đất (●), Thiên tai (▲), Cháy rừng (★), Xung đột (◆)
- **AI**: Google Gemini 2.0 Flash cho news + solutions summary
- **Data**: 42 trạm AQI, 100+ động đất, 157+ thiên tai, 50+ cháy rừng, 22 xung đột, 22 quốc gia ESG, 28 giải pháp
